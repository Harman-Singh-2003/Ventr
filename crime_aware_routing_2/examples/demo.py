...
from ..algorithms.optimization.route_optimizer import RouteOptimizer
...
def main():
    ...
    try:
        ...
        for route_idx, (start_idx, end_idx, route_name) in enumerate(test_routes):
            ...
            # Initialize route optimizer (using absolute path from examples)
            crime_data_path = str(Path(__file__).parent.parent / "data" / "crime_data.geojson")

...
from ..core.cached_network_builder import CachedNetworkBuilder
from ..core.network_builder import find_nearest_nodes
...
class CachedRouteOptimizer:
    ...
    def __init__(self, crime_data_path: str, config: Optional[RoutingConfig] = None,
                 cache_dir: str = "crime_aware_routing/cache", 
